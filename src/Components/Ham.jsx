...
export const Ham = () => {
  return (
    <div>
        ...
        <li class="nav-item active "><Link class="nav-link" to='/wishlist' ><Icon.SuitHeartFill  size="20" /></Link></li>
        <li class="nav-item active "><Link class="nav-link" to='/cart' ><Icon.BagFill  size="20" /></Link></li>
      ...
      <ul class="navbar-nav mt-3 mb-lg-0" >
        ...
        <li class="nav-item active"><Link class="nav-link" to='/cart' ><Icon.BagFill  size="20" /></Link></li>
        <li class="nav-item active"><div className="nav-cart-count">0</div></li>
        <li class="nav-item active"><Link class="nav-link" to='/login' ><Icon.PersonFill  size="25" /></Link></li> 
        </span>
      </ul>
      </div>
